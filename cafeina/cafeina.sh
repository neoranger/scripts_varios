...
# --- 1. CONFIGURACIÓN Y USO DE ICONOS ---
SCRIPT_DIR="$(dirname "$(readlink -f "$0")")"

# Buscar iconos en la ruta instalada del sistema o en el directorio local del script
if [ -f "/usr/share/icons/hicolor/scalable/apps/cafeina-coffee-on.svg" ]; then
    ICON_ON="/usr/share/icons/hicolor/scalable/apps/cafeina-coffee-on.svg"
    ICON_OFF="/usr/share/icons/hicolor/scalable/apps/cafeina-coffee-off.svg"
else
